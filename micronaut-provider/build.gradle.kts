...
kapt {
    arguments {
        ...
        arg("micronaut.processing.annotations", "dev.nanabell.command.manager.*")
        arg("micronaut.processing.group", "dev.nanabell.command.manager")
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("dev.nanabell.command.manager.*")
    }
}
...
dependencies {
    ...
    kapt("io.micronaut:micronaut-inject-java:3.1.3")
    implementation("io.micronaut:micronaut-context:3.1.3")

    kaptTest("io.micronaut:micronaut-inject-java:3.1.3")
